function getRandomGreeting() {
  var greetings = [
    "Did you know this website was made by your mom's dad's mom's dad's mom's dad's mom?",
    ...
    "Cold as ice!",
    "Made in the US!",
    "Made by Infinite Scripter!",
    "Reload the page NOW!",
    "Downloading your passwords...",
    "Running Infinite.exe",
    ...
    "The goal in life is not to live forever,But to create something that will-Juice Wrld 🪽 999",
    "Live your life & outlive death - Juice Wrld(suggested by Grim)",
    "Sponsored by Infinite Script!",
    "Piplup is cute",
    "Adler is a bozo",
